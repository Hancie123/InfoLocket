...
<head>
    ...
    <title>Hancie Phago -InfoLocket Password Recovery</title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left" action="{{url('/login/forgot-password')}}" method="post">
                            @csrf
                            <div class="form">
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        ...
                                        <a  href="{{URL::previous()}}" class="btn btn-primary text-light" wire:navigate>Return Back</a>
                                    </div>
                                </div>
